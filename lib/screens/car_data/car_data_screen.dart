                              ...
                              children: <Widget>[
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    DropdownButtonFormField(
                                      ...
                                      items:
                                          _carController.plazas.map((ciudad) {
                                        return DropdownMenuItem(
                                          value: ciudad.id,
                                          child: Center(
                                            child: Text(
                                ...
                                Row(
                                  ...
                                  children: [
                                    ElevatedButton(
                                      onPressed: () async {
                                        if (_formKeyDatosMotorizado
                                                .currentState!
                                                .validate() &&
                                            _selectedModeloNotifier.value !=
                                                null &&
                                            _selectedModeloNotifier.value?.id !=
                                                0) {
                                          ...
                                          final carResponse =
                                            ...
                                            modelo: _selectedModeloNotifier
                                                .value!.id,
                                            year: _selectedAno,
                                          );
                                          ...
                                          if (carResponse != null) {
                                            ...
                                            Fluttertoast.showToast(
                                              msg:
                                                  'Hubo un problema al registrar los datos del automóvil',
                                            );
                                          }
                                        }
                                      },
